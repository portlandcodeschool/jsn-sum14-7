...
var server = http.createServer(function (req, res) {
  ...
  if (req.method === 'POST') { //make edits to ebook object
  ...
  if (req.method === 'DELETE') { //remove the ebook
